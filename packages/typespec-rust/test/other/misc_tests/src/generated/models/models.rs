...
use super::{
    models_serde,
    xml_helpers::{ItemsTypeOne, ItemsTypeTwo},
    ChatRequestUserMessageContent, Colors, Indices,
};
...
#[non_exhaustive]
pub struct ArrayOfTypeOne {
    #[serde(
        default,
        deserialize_with = "ItemsTypeOne::unwrap",
        rename = "Items",
        serialize_with = "ItemsTypeOne::wrap",
        skip_serializing_if = "Option::is_none"
    )]
    pub items: Option<Vec<TypeOne>>,
}

#[derive(Clone, Default, Deserialize, SafeDebug, Serialize)]
#[non_exhaustive]
pub struct ArrayOfTypeTwo {
    #[serde(
        default,
        deserialize_with = "ItemsTypeTwo::unwrap",
        rename = "Items",
        serialize_with = "ItemsTypeTwo::wrap",
        skip_serializing_if = "Option::is_none"
    )]
    pub items: Option<Vec<TypeTwo>>,
}
